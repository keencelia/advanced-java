...
import mini.ap.lab1.GaussianData;
...
public class DynLineGraphics extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        DistributionData data = new DistributionData(norm);
        ...
        data.points2(leftbound, rightbound, size);
        ...
        final Animation animation = new Transition() {
            {
                setCycleDuration(Duration.millis(90000));
            }
            ...
            protected void interpolate(double frac) {
                ...
                if (points < size) {
                    ...
                    Tuple2 <Double,Double> point = data.next();
                    series.getData().add(new XYChart.Data(point._1, point._2));
                }
